 ...
 /////////////////////////////////////////// Obtener info desde modelo /tracks/id/points.json /////////////////////////////////////////
  ...
  $.getJSON('http://192.168.0.20/tracks/' + gon.track_number.id + '/points.json', function (data){
	elemento = data;
...
////////////////////// Calculo de distancia Recorrida y Velocidad Media /////////////////////////////////////
  ...
  velocidad = parseInt(length)*3600/tiempo_segundos;    // Determina velocidad en km/hr
...
/////////////////////////////////////// Mostrar información afuera del mapa ///////////////////////////////////////////////////////
