...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { latitud: @point.latitud, longitud: @point.longitud, tiempo: @point.tiempo, track_id: @point.track_id }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { latitud: @point.latitud, longitud: @point.longitud, tiempo: @point.tiempo, track_id: @point.track_id }
    assert_redirected_to point_path(assigns(:point))
  end
